...
The ongoworks:bunyan package exports `loggers`, and is instantiated by the `EFrameworkCore.Log` global that can be used anywhere in Reaction code.
...
EFrameworkCore.Log.info "Something we want to see during development"
```
